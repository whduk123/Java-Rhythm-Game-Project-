...
public class DynamicBeat extends JFrame{
	...
	private JButton easyButton = new JButton(new ImageIcon(Main.class.getResource("../images/easyButtonBasic.png")));
	private JButton hardButton = new JButton(new ImageIcon(Main.class.getResource("../images/hardButtonBasic.png")));
	private JButton backButton = new JButton(new ImageIcon(Main.class.getResource("../images/backButtonBasic.png")));
	...
	public DynamicBeat() {
		...
		trackList.add(new Track("Mighty Love Title Image.png","Mighty Love Start Image.png",
				"Mighty Love Game Image.jpg","Mighty Love Selected.mp3","Mighty Love - Joakim Karud.mp3 "));
	...
	public void paint(Graphics g) {
		...
		screenDraw((Graphics2D) screenGraphic); // screenDraw 함수 호출
	...
	public void screenDraw(Graphics2D g)
	{
		...
		if(isGameScreen)
		{
			...
			g.drawString("Mighty Love - Joakim Karud",  20,  702 );
